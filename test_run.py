...
train_df = pd.read_csv('C:/Users/adnalakisic/Desktop/Machine-Learning-Project/df_final.csv')
train_df = train_df.drop('Unnamed: 0', axis=1)
test_df = pd.read_csv('C:/Users/adnalakisic/Desktop/Machine-Learning-Project/test_df_final.csv')
